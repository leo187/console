...
<div id="menu" class="easyui-accordion" fit="true" border="false">
	<div title="超市管理" style="padding:0px;" selected="true" class="arrowsidemenu">
		<ul class="menucontents">
			<li><a href="javascript:void(0)" onclick="jump('<%=rootPath %>superadmin/store/supermarketList')">所有超市</a></li>
		</ul>
	</div>
	<div title="供应商管理" style="padding:0px;" selected="true" class="arrowsidemenu">
		<ul class="menucontents">
			<li><a href="javascript:void(0)" onclick="jump('<%=rootPath %>superadmin/user/suppliersList')">供应商信息</a></li>
		</ul>
	</div>
	<div title="分类管理" >
